        ...
        stage ('Build') {
            ...
            post {
                always {
                    ...
                    warnings canRunOnFailed: true, canResolveRelativePaths: false, consoleParsers: [[parserName: 'Java Compiler (javac)']], defaultEncoding: 'UTF-8', excludePattern: '**/test/**,,**/gate/jape/parser/**', failedNewAll: '0', unstableNewAll: '0', usePreviousBuildAsReference: true
                }
            }
        }
        stage('Document') {
