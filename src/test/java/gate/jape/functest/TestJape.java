 ...
 *
 *  $Id: TestJape.java 19218 2016-04-09 17:15:09Z markagreenwood $
 */
...
public class TestJape extends BaseJapeTests {
	...
	Set<Annotation> res = doTest("/tests/doc0.html", "/jape/TestABC.jape", ac);
	Out.println(res);
	...
	URL applicationURL = TestJape.class.getResource("/tests/jape/jape-test.xgapp");
